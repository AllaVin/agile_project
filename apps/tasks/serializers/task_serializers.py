...
class ListTaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = ['id', 'name', 'status', 'priority', 'project', 'assignee', 'tags', 'deadline']



class CreateUpdateTaskSerializer(serializers.ModelSerializer):
    """
    Сериализатр для создания новой задачи.
    ...
    def create(self, validated_data):
        ...
        task = Task.objects.create(**validated_data) # ** -распаковка
...
class DetailTaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        exclude = ('updated_at', 'deleted_at') # exclude - противополжность fields